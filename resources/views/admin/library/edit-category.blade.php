<x-admin-layout :title="'Edit Category: ' . $category->slug">
    ...
    <div class="max-w-lg">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-6">Edit Category</h3>

            <form method="POST" action="{{ route('admin.library.categories.update', $category) }}">
                @csrf @method('PUT')
                <div class="space-y-4">
                    <div>
