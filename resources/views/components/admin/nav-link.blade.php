...
@php
$classes = $active
    ? 'flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg bg-emerald-600 text-white'
    : 'flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg text-gray-300 hover:bg-gray-800 hover:text-white transition-colors';
@endphp
...
<a href="{{ $href }}" {{ $attributes->merge(['class' => $classes]) }}>
    @switch($icon)
        ...
        @case('credit-card')
            ...
            @break
        @case('flag')
            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9"/></svg>
            @break
        @case('pencil')
